...
// Gera uma preferência de pagamento Mercado Pago (R$ 9,90) para dietapronta.online
// Requer variável de ambiente: MP_ACCESS_TOKEN (Access Token de produção)

import type { VercelRequest, VercelResponse } from 'vercel';

// Habilita CORS básico (caso chame de outro domínio/subdomínio)
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Retorna somente o id (preference_id) usado no front
